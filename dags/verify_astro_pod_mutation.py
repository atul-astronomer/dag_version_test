...
verify_pod_mutation_hook = PythonOperator(
    task_id='verify_pod_mutation_hook',
    python_callable=verify_astro_pod_mutation_hook,
    dag=dag
)


get_pod_specs = PythonOperator(
    task_id='get_pod_specs',
    python_callable=get_pod_specs,
    dag=dag
)

get_pod_name = PythonOperator(
    task_id='get_pod_name',
