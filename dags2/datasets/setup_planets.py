        ...
        if result[0]:
            ...
            if fail_if_not_found:
                ...
                raise AirflowException(
                    f"failed to establish database connection using: {conn.__dict__}"
                )
...
with DAG(
    ...
    postgres_setup_done = EmptyOperator(
        task_id="postgres_setup_done", trigger_rule=TriggerRule.ONE_SUCCESS
    )
